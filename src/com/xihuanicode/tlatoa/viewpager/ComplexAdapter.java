...
public class ComplexAdapter extends PagerAdapter {
	...
	public Object instantiateItem(ViewGroup container, int position) {
		...
		case 0:
			tv.setText(context
					.getString(R.string.tlatoa_appoverview_1st_viewpager_item_text));
			break;
		case 1:
			tv.setText(context
					.getString(R.string.tlatoa_appoverview_2nd_viewpager_item_text));
			break;
		case 2:
			tv.setText(context
					.getString(R.string.tlatoa_appoverview_3rd_viewpager_item_text));
			break;
		}
